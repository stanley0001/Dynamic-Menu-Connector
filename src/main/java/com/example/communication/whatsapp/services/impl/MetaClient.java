...
public class MetaClient<T> implements MetaService {
    ...
    public MetaClient(ConversationRepository conversationRepository, MenuService menuService, SessionService sessionService, RestEntity restEntity) {
    ...
    @Async
    public void userInteraction(String phone, String message, String user) {
    ...
    private void sendWhatsappMessage(String instanceId, String to, String message) {
        ...
        //TODO: Implement Builder pattern or Constructor
